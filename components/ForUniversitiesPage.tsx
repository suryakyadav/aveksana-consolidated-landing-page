...
const ForUniversitiesPage = () => {
    ...
    <section className="relative bg-gray-50 pt-32 pb-20 text-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a href="#" className="bg-transparent text-gray-700 font-semibold px-8 py-3 w-full sm:w-auto hover:text-aveksana-blue transition-colors">
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Core Challenges We Solve</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {UNIVERSITY_CHALLENGES.map(item => (
            <div key={item.title} className="p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-aveksana-blue">{item.title}</h3>
  ...
  const SuiteSection = () => (
    <section className="py-20 bg-gray-50">
       <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">The Aveksana Suite for Universities</h2>
  ...
  const OutcomesSection = () => (
     <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Real results from universities using Aveksana.</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8 text-center max-w-5xl mx-auto">
            {UNIVERSITY_OUTCOMES.map(outcome => (
                <div key={outcome.metric} className="bg-gray-50 p-8 rounded-xl">
  ...
  const SecuritySection = () => (
    <section className="py-20 bg-gray-50">
       <div className="container mx-auto px-6 text-center">
         <h3 className="text-2xl font-bold text-gray-800">Designed for academic security and scalability.</h3>
  ...
  const ImplementationSection = () => (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">A Simple, Phased Implementation</h2>
        <p className="mt-4 text-lg text-gray-600">Typical pilot duration: 4–6 weeks.</p>
  ...
  const TestimonialsSection = () => (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Trusted by Academic Leaders</h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
  ...
  const FinalCTASection = () => (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 max-w-3xl mx-auto">Transform your university’s research ecosystem.</h2>
        <p className="mt-4 text-lg text-gray-600">Book a 1:1 demo and see how Aveksana can accelerate research, funding, and innovation campus-wide.</p>
        <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
         ...
         <p className="mt-4 text-sm text-gray-500">Includes consultation and onboarding support.</p>
      </div>
    </section>
  );
